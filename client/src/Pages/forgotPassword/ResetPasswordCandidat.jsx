...
const ResetPasswordCandidat = () => {
  ...
  const resetSuccess = () =>
    toast.success('Mots de passe réinitialisée avec succès', {
      position: 'top-right',
      autoClose: 5000,
      hideProgressBar: false,
      closeOnClick: true,
  ...
  const initializePassword = async (e) => {
    ...
    if (password === confirmPassword) {
      await axios
        .patch(
          `${process.env.REACT_APP_API_URL}api/user/candidat/reset/${id}`,
          {
            password: password,
          }
        )
  ...
  return (
    <div className="divUpdateProfil">
      <div className="innerUpdateProfil">
        ...
        <div className="right">
          <h2>
            Ajouter nouveau <b>mot de passe</b>
          </h2>
          <form
            className="forInput"
            autoComplete="off"
...
export default ResetPasswordCandidat;
